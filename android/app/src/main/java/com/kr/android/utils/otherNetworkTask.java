...
/**
*  http 통신  -> 노드 서버가 아닌 다른 서버 HTTP 통신 할떄 사용
* @author LCY
* @version 1.0.0
* @since 2020-07-29 오전 11:21
**/
public class otherNetworkTask extends AsyncTask<Void, Void, String>  implements commonConstants {

    private String url;
    private ContentValues values;
    public ArrayList<Map<String,Object>> result;

    public otherNetworkTask(String url, ContentValues values) {
        this.url = url;
        this.values = values;
    };
